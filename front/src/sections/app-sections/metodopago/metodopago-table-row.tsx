...
export function MetodoPagoTableRow({ row, selected, onSelectRow,onEdit, onDelete, }: MetodoPagoTableRowProps) {
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role="checkbox" selected={selected}>
        ...
        <TableCell align="center" size="small" sx={{ width: '20%' }} >{row.payment_method_code}</TableCell>
