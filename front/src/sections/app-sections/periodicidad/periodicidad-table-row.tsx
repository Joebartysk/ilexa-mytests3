...
type PeriodicidadTableRowProps = {
  row: PeriodicidadProps;
  selected: boolean;
  onSelectRow: () => void;
...
export function PeriodicidadTableRow({ row, selected, onSelectRow, onEdit, onDelete, }: PeriodicidadTableRowProps) {
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role="checkbox" selected={selected}>
        ...
        <TableCell align="center" size="small" sx={{ width: '20%' }}>{row.period}</TableCell>

        <TableCell align="center" size="small" sx={{ width: '20%' }}>{row.description}</TableCell>
        ...
        <TableCell align="right" size="small" sx={{ width: '10%' }}>
