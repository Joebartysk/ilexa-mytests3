...
export type TipoComprobanteProps = {
  id: string,
...
type TipoComprobanteTableRowProps = {
  row: TipoComprobanteProps;
  selected: boolean;
  onSelectRow: () => void;
...
export function TipoComprobanteTableRow({ 
  row,
  selected,
  onSelectRow,
  onEdit,
  onDelete,
}: TipoComprobanteTableRowProps) {
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role="checkbox" selected={selected}>
        ...
        <TableCell align="center" size="small" sx={{ width: '15%' }} >{row.voucher_type_code}</TableCell>

        <TableCell align="center" size="small" sx={{ width: '30%' }} >{row.description}</TableCell>

        <TableCell align="center" size="small" sx={{ width: '15%' }} >{row.max_value}</TableCell>
