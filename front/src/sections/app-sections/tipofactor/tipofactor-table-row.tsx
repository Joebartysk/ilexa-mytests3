...
export function TipofactorTableRow({ row, selected, onSelectRow, onEdit, onDelete, }: TipofactorTableRowProps) {
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role="checkbox" selected={selected}>
        ...
        <TableCell component="th" scope="row" size="small" sx={{ width: '20%' }}>
          <Box
            sx={{
              gap: 2,
              display: 'flex',
        ...
        <TableCell size="small" sx={{ width: '30%' }}>{row.factor_type_code}</TableCell>
