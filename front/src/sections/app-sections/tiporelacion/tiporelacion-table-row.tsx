...
type TipoRelacionTableRowProps = {
  row: TipoRelacionProps;
  selected: boolean;
  onSelectRow: () => void;
...
export function TipoRelacionTableRow({ row, selected, onSelectRow, onEdit, onDelete, }: TipoRelacionTableRowProps) {
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role="checkbox" selected={selected}>
        ...
        <TableCell align="center" size="small" sx={{ width: '5%' }} >{row.relation_type_code}</TableCell>

        <TableCell align="center" size="small" sx={{ width: '25%' }} >{row.description}</TableCell>
