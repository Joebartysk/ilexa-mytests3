...
export function ObjetoImpTableRow({ row, selected, onSelectRow, onEdit, onDelete }: ObjetoImpTableRowProps) {
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role="checkbox" selected={selected}>
        ...
        <TableCell align="center" size="small" sx={{ width: '15%' }} >{row.tax_object_code}</TableCell>

        <TableCell align="center" size="small" sx={{ width: '35%' }} >{row.description}</TableCell>
