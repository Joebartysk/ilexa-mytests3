...
class NoLocated(Base):
	__tablename__ = "no_located"
	...
	dates_of_firts_publication = Column(String, nullable=True)  # Manteniendo el nombre exacto
...
def main():
	...
	loader = LoadNoLocated(db_config)
	...
	success_download = loader.download_csv_from_url("http://omawww.sat.gob.mx/cifras_sat/Documents/No%20localizados.csv", file_out)
