...
class Demandables(Base):
	__tablename__ = "demandables"
	...
	dates_of_firts_publication = Column(String, nullable=True)  # Corregido el nombre
...
def main():
	...
	loader = LoadDemandables(db_config)
	...
	success_download = loader.download_csv_from_url("http://omawww.sat.gob.mx/cifras_sat/Documents/Exigibles.csv", file_out)
